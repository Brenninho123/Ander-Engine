...
class Week6DialogueBox extends BasicDialogueBox
{
  ...
  {
    if (music != null) music.fadeIn(1, 0, 0.8);
  }
  ...
  override public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
  {
    ...
    if (dropText != null) dropText.color = 0xFFD89494;
    if (swagDialogue != null) swagDialogue.color = 0xFF3F2021;
  }
  ...
  override function ending()
  {
    ...
    if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'thorns') FlxG.sound.music.fadeOut(2.2, 0);
  }
}
