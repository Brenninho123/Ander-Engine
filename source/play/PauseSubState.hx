...
class PauseSubState extends MusicBeatSubstate
{
  ...
  private function regenMenu():Void
  {
    ...
    for (thing in members)
      if (thing.visible) icanhideu.push(thing);
  }
    ...
    if (accepted)
    {
      ...
      switch (daSelected)
      {
        ...
        case "Exit to menu":
          ...
          if (PlayState.isStoryMode) FlxG.switchState(() -> new ui.story.StoryMenuState());
          else
            FlxG.switchState(() -> new ui.freeplay.FreeplayState());
      }
    }
