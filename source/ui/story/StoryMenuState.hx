...
import ui.story.objects.StoryTitle;
import ui.story.objects.MenuCharacter;
...
class StoryMenuState extends MusicBeatState
{
  ...
  var grpWeekText:FlxTypedGroup<StoryTitle>;
  ...
  override function create()
  {
    ...
    grpWeekText = new FlxTypedGroup<StoryTitle>();
    add(grpWeekText);
    ...
    {
      var weekThing:StoryTitle = new StoryTitle(0, yellowBG.y + yellowBG.height + 10, i);
    ...
    txtWeekTitle.setFormat(Paths.font("vcr.ttf"), 32, 0xFFe55777, CENTER);
    add(txtTracklist);
    add(scoreText);
    add(txtWeekTitle);
  ...
  function selectWeek()
  {
    if (weekUnlocked[curWeek])
    {
      ...
      PlayState.SONG = backend.audio.Song.loadFromJson(PlayState.storyPlaylist[0].toLowerCase() + diffic, PlayState.storyPlaylist[0].toLowerCase());
