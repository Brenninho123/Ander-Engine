...
class RuntimePostEffectShader extends FlxRuntimeShader
{
  ...
  public function updateViewInfo(screenWidth:Float, screenHeight:Float, camera:FunkinCamera):Void
  {
  ...
  override function __createGLProgram(vertexSource:String, fragmentSource:String):GLProgram
  {
    ...
    {
      lime.utils.Log.warn(error); // prevent the app from dying immediately
      return null;
    }
  }
}
