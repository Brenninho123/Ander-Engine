  ...
  override function update(elapsed:Float)
  {
    ...
    if (accepted)
    {
      ...
      else
      {
        ...
        if (FlxG.random.bool(1 / 100 * (10 * 'undertale'.length))) alert_title = 'But it refused';

        FlxG.stage.window.alert(alert_title, 'Missing chart: ${Paths.chart(songs[curSelected].songName, poop)}');
      }
    }
  }
